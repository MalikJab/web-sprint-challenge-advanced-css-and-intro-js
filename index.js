...
function addArtist(id, name, years, genre, nationality, bio){
  ...
  artists.Malik = new addArtist(8, "Malik", "2001-2020", "Web Design", "Arab American", "ok google how do i add text");
  console.log(artists.Malik);
  // (8, Malik, 2001-2020, Web Design, "ok google how do i add text")
